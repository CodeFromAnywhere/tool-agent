...
import { operationUrlObject as apiOperationUrlObject, operations as apiOperations } from "./api";
...
import { operationUrlObject as migrateAgentUserOperationUrlObject, operations as migrateAgentUserOperations } from "./migrate-agent-user";
  ...
  //@ts-ignore
  export const api = createClient<apiOperations>(apiOperationUrlObject, {
    baseUrl: "http://localhost:3000",
    headers: {
      Accept: "application/json",
      "Content-Type": "application/json",
      Authorization: "Bearer " + process.env.AGENT_OPENAPI_AUTH
    },
    timeoutSeconds: 60,
  });
